...
<main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
    ...
    <div
        ...
        <h1 class="text-2xl font-semibold whitespace-nowrap">Pending Infections Data</h1>
    </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                ...
                                <td class="py-4 text-sm font-medium text-right whitespace-nowrap flex justify-center">
                                    <a href="{{ route('infection.edit',$infection->id) }}"
                                    ...
                                    {!! Form::open(['method' => 'DELETE','route' => ['infection.destroy',
                                    $infection->id],'style'=>'']) !!}
