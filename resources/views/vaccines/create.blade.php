...
<main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
    ...
    <div
        ...
        <h1 class="text-2xl font-semibold whitespace-nowrap">When did you get your vaccine shot?</h1>
    </div>
            ...
            <div class="inline-block w-full py-2 align-middle sm:px-6 lg:px-8">
                <div class="overflow-hidden border-b border-gray-200 rounded-md shadow-md">
                    <div class="p-6">
                        ...
                        {!! Form::open(array('route' => 'vaccine.store','method'=>'POST', 'files'=>true)) !!}
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <div class="relative">
                                {!! Form::date('date', null, array('placeholder' => 'Name','class' => 'text-sm
                                sm:text-base relative w-full border rounded placeholder-gray-400 focus:border-indigo-400
                                focus:outline-none py-2 pr-2 pl-2'))
                                !!}
                            </div>
